...
if ( ! class_exists( 'VW_Education_Academy_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class VW_Education_Academy_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new VW_Education_Academy_WPTT_WebFont_Loader( $url );
