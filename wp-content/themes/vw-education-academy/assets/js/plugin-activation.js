jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_education_academy_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-education-academy-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-education-academy-plugin-install');
                button.addClass('button-primary vw-education-academy-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-education-academy-recommended-plugins .vw-education-academy-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-education-academy-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-education-academy-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-education-academy-recommended-plugins').css('display','none');
    });
